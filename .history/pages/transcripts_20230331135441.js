...
export const { name, transcript } = useSelector(state => state.userReducer); 
//ref name
...
//ref name
    var messages = [];
    //var username = dispatch(setName(name));//added this
    await database()
    .ref(`/users/${name}/transcripts/${store.transcript}/messages`)
        .once("value") 
        .then((snapshot) => {
